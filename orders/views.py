...
from .models import Name_pizza,Regular_pizza,Sicilian_pizza,Topping_pizza,Sub_extra,Pasta,Salad,Dinner_platter,Order,User_order,Counter
...
def Table(category):
    if category == "Regular Pizza":
        ...
        menu=Topping_pizza.objects.all()
        columns=1
    elif category == "Salad":
